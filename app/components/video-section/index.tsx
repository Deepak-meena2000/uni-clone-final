        ...
        <div className="flex flex-col md:flex-row-reverse mx-auto max-w-[1280px] w-full justify-center z-1 bg-transparent">
          ...
          <div className="z-10 w-full mt-7 md:mt-0 md:my-auto flex flex-col self-end md:self-center px-6">
            ...
            <div className="hidden md:block">
                ...
                <div className="flex flex-col">
                  <form onSubmit={handleSubmit}>
                    <div className="flex bg-black p-1 pl-2 rounded-xl justify-between">
                      ...
                      <button
                        type="submit"
                        className="text-center text-sm leading-7 justify-between pt-2 ml-2 bg-[#fdf078] rounded-xl z-10 py-2 px-4 disabled:opacity-80 disabled:cursor-not-allowed"
                      >
                        <span>Apply Now</span>
                      </button>
                    </div>
              ...
              <div className="flex lg:hidden max-w-xs flex-col justify-start">
                <div className="w-full max-w-[300px]">
                  <div className="block 2 font-medium p-4 rounded-lg z-10 bg-[#FDEF78] text-black -mt-2 disabled:bg-[#AEAB8C]">
                ...
                <div className="my-2">
                  <p className="text-white md:text-black text-[10px] leading-3">
                    Thank you for your interest in the Uni Card. Download the
                    Uni Cards app now and get your Uni Card in minutes.{" "}
                  </p>
                </div>
              </div>
            </div>
